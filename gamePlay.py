...
# loads the images needed for game
    def images(self):
        ...
        self.explode=pygame.image.load('explosion.png').convert_alpha()
...
# loads the sounds needed for game    
    def sounds(self):
        ...
        self.gameclear=pygame.mixer.Sound('gameclear.wav')
        self.beamSound=pygame.mixer.Sound('ufo.wav')
        self.beamSound.set_volume(0.2)
        self.pickUp=pygame.mixer.Sound('score.wav')
