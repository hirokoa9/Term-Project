...
# loads and configures beam image    
    def __init__(self,x=230,y=240):
        ...
        self.x=x
        self.y=y
        self.image = pygame.image.load('images/beam.png').convert_alpha()
        self.rect=self.image.get_rect()
        self.mask=pygame.mask.from_surface(self.image)
        self.rect.move_ip(self.x,self.y)
...
# loads and configures the targets
    def __init__(self,xCoord,player):
        ...
        self.ground=10
        self.image = pygame.image.load('images/stick_figure.png').convert_alpha()
...
# loads and configures the targets
    def __init__(self,xCoord,player):
        ...
        self.size=(40,65)
        self.ySize=65
        self.image = pygame.image.load('images/building.png').convert_alpha()
        self.image = pygame.transform.scale(self.image,self.size)
        self.mask=pygame.mask.from_surface(self.image)
        self.x=xCoord
        self.origY=self.windowHeight-self.ground-self.ySize
